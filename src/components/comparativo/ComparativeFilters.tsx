...
import { Check, ChevronDown, X, Filter, Building2 } from 'lucide-react';
 import {
   Popover,
   PopoverContent,
   PopoverTrigger,
     ...
     <div className="flex flex-wrap items-center gap-3">
      ...
      {isGlobalRole && regionales && (
       ...
       {(isGlobalRole || isLeader) && jefes && (
         <Popover open={jefeOpen} onOpenChange={setJefeOpen}>
           <PopoverTrigger asChild>
             <Button variant="outline" className="w-[180px] justify-between bg-card">
               <span className="truncate">
                 {filters.codigoJefe
           ...
           <PopoverContent className="w-[250px] p-1 max-h-[300px] overflow-auto" align="start">
             <div
       ...
       {asesores && asesores.length > 0 && (
         <Popover open={asesorOpen} onOpenChange={setAsesorOpen}>
           ...
           <PopoverContent className="w-[280px] p-0" align="start">
             <div className="p-2 border-b flex justify-between">
               <button
                 onClick={() => onFiltersChange({ ...filters, codigosAsesor: asesores.map(a => a.codigo_asesor!) })}
                 className="text-xs text-primary hover:underline"
               >
                 Seleccionar todos
               </button>
